...
// Docker 部署模式
{
    todoApiBaseUrl: '/api',                // 通过 Nginx + Gateway 访问
    gatewayUrl: '/api',
    apiBaseUrl: '/api',
    logApiBaseUrl: '/api',
    enableMock: false
...
// 本地开发模式
{
    todoApiBaseUrl: 'http://127.0.0.1:8080', // 直连 TODO API
    gatewayUrl: 'http://127.0.0.1:8888',     // 可选：通过网关访问
    apiBaseUrl: 'http://127.0.0.1:8080',     // RBAC / 管理后台 API
