...
const mockData = {
  // GET /todos - Todo 列表
  '/todos': [
    { id: 1, title: '用 Go 重写 Python 示例', done: false, created_at: '2025-12-04T10:00:00Z' },
    { id: 2, title: '补齐单元测试', done: true, created_at: '2025-12-04T11:00:00Z' }
  ],

  // POST /todos - 创建
  'POST /todos': { id: 3, title: '学习 channel', done: false, created_at: '2025-12-04T12:00:00Z' },

  // PUT /todos/{id} - 更新
  'PUT /todos/3': { id: 3, title: '学习 channel', done: true, created_at: '2025-12-04T12:00:00Z' },

  // DELETE /todos/{id}
  'DELETE /todos/3': { code: 'OK' },
